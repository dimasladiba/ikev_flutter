...
class MethodChannelFlutterVpn extends FlutterVpnPlatform {
  ...
  @visibleForTesting
  final eventTrafficChannel = const EventChannel('flutter_vpn_traffic');
  ...
  @override
  // TODO: implement onTrafficReport
  Stream<Map> get onTrafficReport => eventTrafficChannel.receiveBroadcastStream().map((e) => e);
  /// Get current state.
  @override
