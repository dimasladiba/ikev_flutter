...
class FlutterVpnPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    private val vpnStateServiceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName, service: IBinder) {
            ...
            vpnStateService?.registerListener(VpnStateHandler, iTrafficMeasurer)
        }
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        //Register itrafficMeasurer to handle traffic.
        trafficChannel = EventChannel(flutterPluginBinding.binaryMessenger, "flutter_vpn_traffic")
        trafficChannel.setStreamHandler(iTrafficMeasurer)
