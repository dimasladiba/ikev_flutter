...
public class VpnStateService extends Service {
    ...
    private final TrafficSpeedMeasurer trafficSpeedMeasurer = new TrafficSpeedMeasurer(TrafficType.ALL);
    ...
    public void unregisterListener(VpnStateListener listener, ITrafficSpeedListener iTrafficSpeedListener) {
        mListeners.remove(listener);
        trafficSpeedMeasurer.removeListener(iTrafficSpeedListener);
    }
